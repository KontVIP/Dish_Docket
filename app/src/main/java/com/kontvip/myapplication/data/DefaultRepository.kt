...
class DefaultRepository(
    ...
    private val dataToDomainProcess: DataToDomainProcess
) : Repository {
    ...
    override suspend fun mealsByName(name: String): DomainMealList {
        ...
        return dataToDomainProcess.processDataToDomainMealList(fetchMealList)
    }
    ...
    override suspend fun recipeById(id: Int): DomainRecipeList {
        ...
        return dataToDomainProcess.processDataToDomainRecipeList(fetchRecipeList)
    }

    override suspend fun randomRecipe(): DomainRecipeList {
        val fetchRecipeList = object : FetchData.RecipeList {
            override suspend fun fetchCache(): CacheRecipeList = CacheRecipeList()
